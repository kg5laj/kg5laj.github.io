  ...
  <body>    
    ...
    <section id="hero" class="text-white tm-font-big tm-parallax">
      ...
      <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">              
        <div class="container">   
          <div class="tm-next">
              <a href="#hero" class="navbar-brand">Graced Ministry</a>
          </div>             
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#stories">Stories</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#photos">Photos</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#work">Who We Are</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=CFUPXV6FCAUF4" target="_blank">Donate Now</a>
              </li>                    
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">Graced Ministry</h2>
            <p class="tm-hero-subtitle">
              Changing lives, one penny at a time.
              <br />subtitle or story if we want
            </p>
        </div>        
      </div>
...
<br><br>
<strong>Where We Hope To Go:</strong> As we continue to collect pennies, our hope is to increase the ways it might impact others. The mission of Graced Ministry is to change lives one penny at a time.
                </p>
<br>
                <div class="tm-next">
...
<br><br><br>
        ...
        <div class="row tm-section-pad-top">
          <div class="col-lg-4">
            <i class="fas fa-4x fa-folder text-center tm-icon"></i>
            <h4 class="text-center tm-text-primary mb-4">Ambassador Application</h4>
            <p>
        ...
        <div class="col-lg-4 mt-5 mt-lg-0">
          <i class="fas fa-4x fa-pray text-center tm-icon"></i>
          <h4 class="text-center tm-text-primary mb-4">Make Your Own Pack</h4>
          <p>
        ...
        <div class="col-lg-4 mt-5 mt-lg-0">
          <i class="fas fa-4x fa-handshake text-center tm-icon"></i>
          <h4 class="text-center tm-text-primary mb-4">Donation List</h4>
          <p>
    ...
    <section id="stories" class="tm-section-pad-top">
      <div class="container tm-container-gallery">
        <div class="row">
          <div class="text-center col-12">
              <h2 class="tm-text-primary tm-section-title mb-4">Stories</h2>
              <p class="mx-auto tm-work-description">

<strong><u>A VERY SPECIAL PENNY</strong></u><br><br>
...
<br><br>
<img src="img/penny-boys.jpg" style="width:100%">
<br><br>
...
<br><br>
<img src="img/1000-penny.jpg" style="width:100%">
<br><br>
...
<br><br>
<strong><u>Hurricane Harvey Relief Project - A Heart Bigger Than Her</strong></u><br><br>
Bella Grace and her momma watched a documentary on homless children. When Bella Grace saw this, she wanted to help. Bella Grace went straight to her room and packed all of her clothes that she no longer wanted. She did this for the children. She saw a need, and wanted to fix it. Until they heard about Graced's drop off locations, she didn't know where to take the bags. When Kiana, Bella Grace's mom, told her that's where they were going to take her clothes, Bella Grace asked about the children. Kiana said they would go to the Hurricane Harvey children that are in need of items right now. Bella Grace looked at her mom, smiled, and said "I will always help!"
<br><br><img src="img/bella-grace.jpg" style="width:100%">
              </p>
          </div>            
        </div>
      </div></section>

    <section id="photos" class="tm-section-pad-top">
      <div class="container tm-container-gallery">
        <div class="row">
          <div class="text-center col-12">
              <h2 class="tm-text-primary tm-section-title mb-4">Photos</h2>
              <p class="mx-auto tm-work-description">

<!-- Photo Grid -->
<div class="row"> 
  <div class="column">
    <img src="img/flex-01.jpg" style="width:100%">
    <img src="img/flex-02.jpg" style="width:100%">
    <img src="img/flex-03.jpg" style="width:100%">
    <img src="img/flex-04.jpg" style="width:100%">
    <img src="img/flex-05.jpg" style="width:100%">
    <img src="img/flex-01.jpg" style="width:100%">
    <img src="img/flex-02.jpg" style="width:100%">
  </div>
  <div class="column">
  ...
  <div class="column">
    ...
    <section id="work" class="tm-section-pad-top">
      <div class="container tm-container-gallery">
        <div class="row">
          <div class="text-center col-12">
              <h2 class="tm-text-primary tm-section-title mb-4">Who We Are</h2>
              <p class="mx-auto tm-work-description">
                    ...
                    <div class="grid tm-gallery">
                      <a href="img/gallery-img-01.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Koedi <span>Nealy</span> <font size="-1">President</font></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-02.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Marit <span>Broussard</span> <font size="-1">Vice President</font></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-03.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Linda <span>Hill</span> <font size="-1">Treasurer</font></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-04.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Marianne <span>Tadros</span> <font size="-1">Secretary</font></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-05.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Kristi <span>Nealy</span> <font size="-1">Chaplain</font></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-06.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          ...
                          <figcaption>
                            <h2><i>Megan <span>Miller</span> <font size="-1">Officer</font></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-06.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="img/gallery-tn-06.jpg" alt="Image" class="img-fluid">
                          <figcaption>
                            <h2><i>Another <span>Officer</span> <font size="-1">Title</font></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="img/gallery-img-06.jpg">
    ...
    <section id="contact" class="tm-section-pad-top tm-parallax-2">
      <div class="container tm-container-contact">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
              <a href="mailto:gracedministry@gmail.com" class="tm-contact-item-link">
                  <i class="fas fa-3x fa-envelope mr-4"></i>
                  <span class="mb-0">gracedministry@gmail.com</span>
              </a>              
            </div>
            <div class="col-sm-12 col-md-6 d-flex align-items-center tm-contact-item">
      ...
      <footer class="text-center small tm-footer">
          <p class="mb-0">
            Copyright &copy; 2020 Graced Ministry. All rights reserved.
